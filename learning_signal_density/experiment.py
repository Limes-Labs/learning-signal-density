...
def run_condition(seed: int, condition: str, material_count: int, epochs: int) -> dict:
    ...
    return {
        ...
        "ranked_induction_min_confidence": _round(pipeline.ranked_induction_min_confidence),
        "train_calibration_event_count": pipeline.train_calibration_event_count,
        "validation_calibration_event_count": pipeline.validation_calibration_event_count,
        "ranked_diversity_penalty": _round(pipeline.ranked_diversity_penalty),
        "ranked_unique_modifier_count": pipeline.ranked_unique_modifier_count,
        "ranked_max_modifier_count": pipeline.ranked_max_modifier_count,
        "validation_tuning_cost_tokens": gate["validation_tuning_cost_tokens"],
...
def _aggregate(rows: list[dict]) -> dict:
    keys = (
        ...
        "ranked_induction_min_support",
        "ranked_induction_min_confidence",
        "train_calibration_event_count",
        "validation_calibration_event_count",
